...
@description('Default resource group for existing private DNS zones. Applied as fallback for any empty entries in existingDnsZones. Leave empty to create new zones.')
...
// Resolve DNS zones: apply dnsZonesResourceGroup as fallback for any empty entries in existingDnsZones
var resolvedDnsZones = {
  'privatelink.services.ai.azure.com': !empty(existingDnsZones['privatelink.services.ai.azure.com']) ? existingDnsZones['privatelink.services.ai.azure.com'] : dnsZonesResourceGroup
  'privatelink.openai.azure.com': !empty(existingDnsZones['privatelink.openai.azure.com']) ? existingDnsZones['privatelink.openai.azure.com'] : dnsZonesResourceGroup
  'privatelink.cognitiveservices.azure.com': !empty(existingDnsZones['privatelink.cognitiveservices.azure.com']) ? existingDnsZones['privatelink.cognitiveservices.azure.com'] : dnsZonesResourceGroup
  'privatelink.search.windows.net': !empty(existingDnsZones['privatelink.search.windows.net']) ? existingDnsZones['privatelink.search.windows.net'] : dnsZonesResourceGroup
  'privatelink.blob.core.windows.net': !empty(existingDnsZones['privatelink.blob.core.windows.net']) ? existingDnsZones['privatelink.blob.core.windows.net'] : dnsZonesResourceGroup
  'privatelink.documents.azure.com': !empty(existingDnsZones['privatelink.documents.azure.com']) ? existingDnsZones['privatelink.documents.azure.com'] : dnsZonesResourceGroup
  'privatelink.file.core.windows.net': !empty(existingDnsZones['privatelink.file.core.windows.net']) ? existingDnsZones['privatelink.file.core.windows.net'] : dnsZonesResourceGroup
}
...
module validateExistingResources 'modules-network-secured/validate-existing-resources.bicep' = {
  ...
  params: {
    ...
    existingDnsZones: resolvedDnsZones
