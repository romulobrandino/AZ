...
|---|---|
| [linux-azurecli.md](linux-azurecli.md) | Install the Azure CLI on Linux/Ubuntu (`apt`). For Windows install + `az login`, see [01-getting-started/README.md](../01-getting-started/README.md). |
