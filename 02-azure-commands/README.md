...
| [cloud-shell.md](cloud-shell.md) | Step-by-step guide to enable/open Azure Cloud Shell (Bash or PowerShell), first-time storage setup, and tips (persistence, upload/download, reset). |
...
| [storage/create-storage-account.md](storage/create-storage-account.md) | Create a resource group + a globally-unique storage account in the same region, with PowerShell and Azure CLI. |
